...
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/ropkiplagat/fxpulse/main/siteground_api.py" -OutFile "C:\fxpulse\siteground_api.py"
...
.\venv\Scripts\python.exe -c "import config; import copy_trades; import siteground_api; print('Imports OK')"
